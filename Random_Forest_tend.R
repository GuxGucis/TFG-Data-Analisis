...
# =====> GENERAL <=====
# Especifica el nombre del archivo y la ruta donde quieres guardar el gráfico
filename <- paste0(baseurl, "Graficas/Random_Forest/RM_FGE2_ALL.png")
# Abre el dispositivo PNG
png(filename, width = 1500, height = 1400)
# Para visualizar los resultados puedes usar plot
plot(vimp_results)
...
# =====> ERROR <=====
errorRate <- gg_error(rf_fit_FGE2)
png(paste0(baseurl, "Graficas/Random_Forest/RM_ErrorRate_FGE2_ALL.png"), width = 1500, height = 1400)
plot(errorRate)
dev.off()
...
importance$Variable <- rownames(importance)
names(importance) <- c("Importance", "Variable" )
Importancia2$imp_all_FGE <- importance$Importance[match(Importancia2$Variable, importance$Variable)]

# Plot using ggplot2
png(paste0(baseurl, "Graficas/Random_Forest/RM_VarImp_FGE2_ALL.png"), width = 1500, height = 1400)
ggplot(importance, aes(x = reorder(Variable, vimp_results$importance), y = vimp_results$importance)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  labs(title = "Variable Importance Plot (EKFC)", x = "Variables", y = "Importance") +
  coord_flip()  # This flips the axis to make labels readable
dev.off()

# =====> CURVAS DE SUPERVIVIENCIA <=====
png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_km_FGE2_ALL.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2, collapse=TRUE, cens.model="km")
dev.off()

png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_rfscr_FGE2_ALL.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2, collapse=TRUE, cens.model="rfsrc")
dev.off()
...
# =====> GENERAL <=====
# Especifica el nombre del archivo y la ruta donde quieres guardar el gráfico
filename <- paste0(baseurl, "Graficas/Random_Forest/RM_FGE2_HM.png")
# Abre el dispositivo PNG
png(filename, width = 1500, height = 1400)
# Para visualizar los resultados puedes usar plot
plot(vimp_results)
...
# =====> ERROR <=====
errorRate <- gg_error(rf_fit_FGE2_hm)
png(paste0(baseurl, "Graficas/Random_Forest/RM_ErrorRate_FGE2_HM.png"), width = 1500, height = 1400)
plot(errorRate)
dev.off()
...
importance$Variable <- rownames(importance)
names(importance) <- c("Importance", "Variable" )
Importancia2$imp_hm_FGE <- importance$Importance[match(Importancia2$Variable, importance$Variable)]

# Plot using ggplot2
png(paste0(baseurl, "Graficas/Random_Forest/RM_VarImp_FGE2_HM.png"), width = 1500, height = 1400)
ggplot(importance, aes(x = reorder(Variable, vimp_results$importance), y = vimp_results$importance)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  labs(title = "Variable Importance Plot (EKFC)", x = "Variables", y = "Importance") +
...
# =====> CURVAS DE SUPERVIVIENCIA <=====
png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_km_FGE2_HM.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE_hm, collapse=TRUE, cens.model="km")
dev.off()

png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_rfscr_FGE2_HM.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE_hm, collapse=TRUE, cens.model="rfsrc")
dev.off()
...
# =====> GENERAL <=====
# Especifica el nombre del archivo y la ruta donde quieres guardar el gráfico
filename <- paste0(baseurl, "Graficas/Random_Forest/RM_FGE2_TR.png")
# Abre el dispositivo PNG
png(filename, width = 1500, height = 1400)
# Para visualizar los resultados puedes usar plot
plot(vimp_results)
...
# =====> ERROR <=====
errorRate <- gg_error(rf_fit_FGE2_tr)
png(paste0(baseurl, "Graficas/Random_Forest/RM_ErrorRate_FGE2_TR.png"), width = 1500, height = 1400)
plot(errorRate)
dev.off()
...
importance$Variable <- rownames(importance)
names(importance) <- c("Importance", "Variable" )
Importancia2$imp_tr_FGE <- importance$Importance[match(Importancia2$Variable, importance$Variable)]

# Plot using ggplot2
png(paste0(baseurl, "Graficas/Random_Forest/RM_VarImp_FGE2_TR.png"), width = 1500, height = 1400)
ggplot(importance, aes(x = reorder(Variable, vimp_results$importance), y = vimp_results$importance)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  labs(title = "Variable Importance Plot (EKFC)", x = "Variables", y = "Importance") +
...
# =====> CURVAS DE SUPERVIVIENCIA <=====
png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_km_FGE2_TR.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE_tr, collapse=TRUE, cens.model="km")
dev.off()

png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_rfscr_FGE2_TR.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE_tr, collapse=TRUE, cens.model="rfsrc")
dev.off()
...
# =====> GENERAL <=====
# Especifica el nombre del archivo y la ruta donde quieres guardar el gráfico
filename <- paste0(baseurl, "Graficas/Random_Forest/RM_FGE2_HMTR.png")
# Abre el dispositivo PNG
png(filename, width = 1500, height = 1400)
# Para visualizar los resultados puedes usar plot
plot(vimp_results)
...
# =====> ERROR <=====
errorRate <- gg_error(rf_fit_FGE2_hmtr)
png(paste0(baseurl, "Graficas/Random_Forest/RM_ErrorRate_FGE2_HMTR.png"), width = 1500, height = 1400)
plot(errorRate)
dev.off()
...
importance$Variable <- rownames(importance)
names(importance) <- c("Importance", "Variable" )
Importancia2$imp_tr_hm_FGE <- importance$Importance[match(Importancia2$Variable, importance$Variable)]

# Plot using ggplot2
png(paste0(baseurl, "Graficas/Random_Forest/RM_VarImp_FGE2_HMTR.png"), width = 1500, height = 1400)
ggplot(importance, aes(x = reorder(Variable, vimp_results$importance), y = vimp_results$importance)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  labs(title = "Variable Importance Plot (EKFC)", x = "Variables", y = "Importance") +
...
# =====> CURVAS DE SUPERVIVIENCIA <=====
png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_km_FGE2_HMTR.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2_hmtr, collapse=TRUE, cens.model="km")
dev.off()

png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_rfscr_FGE2_HMTR.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2_hmtr, collapse=TRUE, cens.model="rfsrc")
dev.off()
...
plot.survival(rf_fit_FGE_nn, collapse=TRUE, cens.model="rfsrc")
dev.off()
...
# =====> GENERAL <=====
# Especifica el nombre del archivo y la ruta donde quieres guardar el gráfico
filename <- paste0(baseurl, "Graficas/Random_Forest/RM_FGE2_NN.png")
# Abre el dispositivo PNG
png(filename, width = 1500, height = 1400)
# Para visualizar los resultados puedes usar plot
plot(vimp_results)
...
# =====> ERROR <=====
errorRate <- gg_error(rf_fit_FGE2_nn)
png(paste0(baseurl, "Graficas/Random_Forest/RM_ErrorRate_FGE2_NN.png"), width = 1500, height = 1400)
plot(errorRate)
dev.off()
...
importance$Variable <- rownames(importance)
names(importance) <- c("Importance", "Variable" )
Importancia2$imp_NN_FGE <- importance$Importance[match(Importancia2$Variable, importance$Variable)]

# Plot using ggplot2
png(paste0(baseurl, "Graficas/Random_Forest/RM_VarImp_FGE2_NN.png"), width = 1500, height = 1400)
ggplot(importance, aes(x = reorder(Variable, vimp_results$importance), y = vimp_results$importance)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  labs(title = "Variable Importance Plot (EKFC)", x = "Variables", y = "Importance") +
...
# =====> CURVAS DE SUPERVIVIENCIA <=====
png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_km_FGE2_NN.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2_nn, collapse=TRUE, cens.model="km")
dev.off()

png(paste0(baseurl, "Graficas/Random_Forest/RM_SurvCurv_rfscr_FGE2_NN.png"), width = 2000, height = 2000)
plot.survival(rf_fit_FGE2_nn, collapse=TRUE, cens.model="rfsrc")
dev.off()

# ------------------- EXPORTAR -------------------
print('------------------- EXPORTAR -------------------')
write.csv(Importancia, paste0(baseurl, "data/importancia.csv"), row.names = FALSE)
write.csv(Importancia2, paste0(baseurl, "data/importancia2.csv"), row.names = FALSE)
