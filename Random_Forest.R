...
for (i in mice){
  ...
  names(importance) <- c("Importance", "Variable" )
  Importancia <- Importancia %>%
    mutate(imp_all_FGE = ifelse(is.na(match(Variable, importance$Variable)), imp_all_FLL, imp_all_FLL + importance$Importance[match(Variable, importance$Variable)]))
  ...
  names(importance) <- c("Importance", "Variable" )
  Importancia <- Importancia %>%
    mutate(imp_all_FGE = ifelse(is.na(match(Variable, importance$Variable)), imp_hm_FLL, imp_hm_FLL + importance$Importance[match(Variable, importance$Variable)]))
  ...
  names(importance) <- c("Importance", "Variable" )
  Importancia <- Importancia %>%
    mutate(imp_all_FGE = ifelse(is.na(match(Variable, importance$Variable)), imp_tr_FLL, imp_tr_FLL + importance$Importance[match(Variable, importance$Variable)]))
  ...
  names(importance) <- c("Importance", "Variable" )
  Importancia <- Importancia %>%
    mutate(imp_all_FGE = ifelse(is.na(match(Variable, importance$Variable)), imp_tr_hm_FLL, imp_tr_hm_FLL + importance$Importance[match(Variable, importance$Variable)]))
  ...
  names(importance) <- c("Importance", "Variable" )
  Importancia <- Importancia %>%
    mutate(imp_all_FGE = ifelse(is.na(match(Variable, importance$Variable)), imp_NN_FLL, imp_NN_FLL + importance$Importance[match(Variable, importance$Variable)]))
}
