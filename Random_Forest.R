...
# Filtrar las filas con datos faltantes en 'FGE_microten' y 'dias_transcurridos'
data <- data %>%
  filter(!is.na(FGE_microten) & !is.na(dias_transcurridos))
...
# Verificar que ambos modelos tengan el mismo número de observaciones
cat("Número de observaciones en el modelo longitudinal:\n")
print(nrow(data))
cat("Número de observaciones en el modelo de supervivencia:\n")
print(nrow(data))
